  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          "h1",
          { className: "browser__mainHeader" },
          "Github user browser"
        ),
        React.createElement(
          "form",
          { className: "browser__form", onSubmit: function onSubmit(event) {
  ...
  _createClass(User, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement("img", { className: "browser__user-picture", src: this.props.user.avatar_url, style: { maxWidth: '100px', maxHeight: '100px' } }),
        React.createElement(
          "a",
          { className: "browser__user", href: this.props.user.html_url, target: "_blank" },
